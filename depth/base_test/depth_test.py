...
INPUT_IMAGE_PATH = Path(r"C:\Users\khrha\Desktop\SWPJ_4\Depth\base_test\result_4\test_4.jpg")

# 여기 숫자만 그때그때 바꾸면 됩니다.
# 예: 1 -> result_1, 2 -> result_2, 3 -> result_3
RESULT_NUMBER = 4

BASE_OUTPUT_DIR = Path(r"C:\Users\khrha\Desktop\SWPJ_4\Depth\base_test\result_4")
