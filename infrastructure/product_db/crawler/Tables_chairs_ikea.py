...
TOP_CATEGORY_CODE = "tables_chairs"
TOP_CATEGORY_NAME = "Tables & chairs"
START_URL = "https://www.ikea.com/kr/en/cat/tables-chairs-fu002/"

# Storage furniture ?덉뿉???쒖쇅???섏쐞 移댄뀒怨좊━
EXCLUDE_CATEGORY_NAMES = {"children's tables", "children's chairs", "baby chairs & highchairs"}

# ?ъ슜???붿껌??留욎텣 ????대쫫
OUTPUT_LABEL = "Tables_chairs"
JSON_FILE_NAME = "ikea_Tables_chairs.json"
SKIPPED_FILE_NAME = "ikea_skipped_Tables_chairs.json"
IMAGE_FOLDER_NAME = "Tables_chairs"
IMAGE_FILE_PREFIX = "Tables chairs"
