...
TOP_CATEGORY_CODE = "beds_mattresses"
TOP_CATEGORY_NAME = "Beds & mattresses"
START_URL = "https://www.ikea.com/kr/en/cat/beds-mattresses-bm001/"

# Storage furniture ?덉뿉???쒖쇅???섏쐞 移댄뀒怨좊━
EXCLUDE_CATEGORY_NAMES = set()

# ?ъ슜???붿껌??留욎텣 ????대쫫
OUTPUT_LABEL = "Beds_mattresses"
JSON_FILE_NAME = "ikea_Beds_mattresses.json"
SKIPPED_FILE_NAME = "ikea_skipped_Beds_mattresses.json"
IMAGE_FOLDER_NAME = "Beds_mattresses"
IMAGE_FILE_PREFIX = "Beds mattresses"
...
def parse_dimensions(text):
    ...
    width_patterns = [
        r"(?:\bwidth\b)\s*[:=]?\s*(?P<val>\d+(?:\.\d+)?)\s*(?P<unit>mm|cm|m)?",
